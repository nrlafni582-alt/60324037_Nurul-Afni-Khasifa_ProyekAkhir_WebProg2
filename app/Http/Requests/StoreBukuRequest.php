...
public function withValidator($validator)
{
    $validator->after(function ($validator) {
        ...
        // Jika kategori Programming maka bahasa wajib Inggris
        $kategoriNama = null;
        if ($this->kategori_id) {
            $kategori = Kategori::find($this->kategori_id);
            $kategoriNama = $kategori ? $kategori->nama : null;
        } elseif ($this->kategori) {
            $kategoriNama = $this->kategori;
        }

        if (
            $kategoriNama == 'Programming' &&
            $this->bahasa != 'Inggris'
        ) {
        ...
        // Jika tahun terbit sebelum 2000 maka stok maksimal 5
        if (
