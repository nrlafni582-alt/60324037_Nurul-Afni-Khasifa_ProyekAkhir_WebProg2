...
<div class="row">
        <div class="card mb-3">
            <div class="card-body text-center">
                {!! QrCode::size(200)->generate(route('anggota.show', $anggota->id)) !!}
                <p class="mt-2 mb-0">QR Anggota</p>
            </div>
        </div>
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table class="table table-borderless">
                    ...
                    <tr>
                        ...
                        <td> : {{ \Carbon\Carbon::parse($anggota->tanggal_lahir)->format('d F Y') }} ({{ $anggota->umur }} tahun)
</td>
                    </tr>
                    <tr>
                        <td class="fw-bold">
