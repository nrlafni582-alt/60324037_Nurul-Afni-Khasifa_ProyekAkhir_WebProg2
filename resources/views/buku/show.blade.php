...
<div class="row">
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                {{-- Badge Kategori --}}
                    <div class="mb-3">
                    <span class="badge bg-{{ $buku->kategori_name == 'Programming' ? 'primary' : ($buku->kategori_name == 'Database' ? 'success' : ($buku->kategori_name == 'Web Design' ? 'info' : ($buku->kategori_name == 'Networking' ? 'warning' : 'danger'))) }} fs-6">
                        <i class="bi bi-tag"></i> {{ $buku->kategori_name }}
                    </span>
                </div>
    ...
    <div class="col-md-4">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body d-grid gap-2">
                ...
                @if ($buku->stok > 0)
                    <a href="{{ route('pinjam.buku', $buku->id) }}" class="btn btn-success w-100">
    ...
    <button type="button"
            class="btn btn-danger btn-delete w-100"
...
<div class="card mb-3">
        ...
        <div class="card mb-3">
            <div class="card-body text-center">
                {!! QrCode::size(180)->generate(route('buku.show', $buku->id)) !!}
                <p class="mt-2 mb-0">QR Buku</p>
            </div>
        </div>
